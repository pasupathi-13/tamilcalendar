...
function Muhurtham() {
  ...
  const dynamicMuhurthamSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://tamilcalendar-c0q6.onrender.com/muhurtham?year=${selectedYear}`
    },
    "publisher": {
      "@type": "Organization",
      "name": "Tamil Calendar",
  ...
  return (
    <main className="muhurtham-container">
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://tamilcalendar-c0q6.onrender.com/muhurtham" />
        ...
        <meta property="og:url" content="https://tamilcalendar-c0q6.onrender.com/muhurtham" />
